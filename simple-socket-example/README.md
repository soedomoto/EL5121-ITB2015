...
### Screeenshots
![Socket Server](/simple-socket-example/screenshots/Server.png?raw=true "Socket Server" =250x)
![Socket Client](/simple-socket-example/screenshots/Client.png?raw=true "Socket Client" =250x)
